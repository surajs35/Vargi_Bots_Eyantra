...
# ---------------------- SPREADSHEET UPDATE -----------------
def spreadsheet_update(parameter):

    parameters = {"Team Id":"VB_441","Unique Id":"SwSuSukA"}
    parameters.update(parameter)
    print(parameters)
    URL = "https://script.google.com/macros/s/AKfycbwIMSQETI9ZaFgbtLhPd_Q1H0vSZR_mSjVTwtUwVLi0tF6KUk4/exec"
